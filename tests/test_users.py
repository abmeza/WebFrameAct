...
sys.path.append('../WebFrameAct')
from mainFile import app, db
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response = self.register('the_super_long_username', 'test@example.com',
                                 'FlaskIsAwesome')
    ...
    def test_invalid_email_registration(self):
        ...
        response = self.register('test2', 'testnewexample', 'FlaskIsAwesome')
        self.assertIn(b'Invalid email address.', response.data)
